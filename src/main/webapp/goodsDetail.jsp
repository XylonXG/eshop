...
<section>
    <div class="pc-details" >
        <div class="containers">
            <div class="pc-nav-item"><a class="pc-title" href="#">${goods.goodsType}</a></div>
            <div class="pc-details-l">
                <div class="pc-product clearfix">
                    <div class="pc-product-h">
                        <div class="pc-product-top"><img src="${goods.goodsImgHttpURL}" id="big_img" width="418" height="418"></div>
                        <div class="pc-product-bop clearfix" id="pro_detail">
                            <ul>
                                <li><a href="javascript:void(0);" class="cur" simg="${goodsDetail.goodsDetailImgHttpURL1}"><img src="${goodsDetail.goodsDetailImgHttpURL1}" width="58" height="58"></a> </li>
                                <li><a href="javascript:void(0);" simg="${goodsDetail.goodsDetailImgHttpURL2}"><img src="${goodsDetail.goodsDetailImgHttpURL2}" width="58" height="58"></a> </li>
                                <li><a href="javascript:void(0);" simg="${goodsDetail.goodsDetailImgHttpURL3}"><img src="${goodsDetail.goodsDetailImgHttpURL3}" width="58" height="58"></a> </li>
                        </div>
                    </div>
                    <div class="pc-product-t">
                        <div class="pc-name-info">
                            <h1>${goodsDetailList[loop.count-1].goodsDesc}</h1>
                            <p class="clearfix pc-rate"><strong>￥${goodsDetail.goodsSalePrice}</strong>
                            <p>由<a href="#" class="reds">${goods.goodsSupplier}</a> 负责发货，并提供售后服务。</p>
                        </div>
                        ...
                        <div class="pc-size">
                            ...
                            <div class="pc-telling clearfix">
                                ...
                                <div class="pc-adults">
                                    <ul>
                                        <li><a href="#" title="黑色" class="cur"><img src="${goodsDetail.goodsDetailImgHttpURL1}" width="35" height="35"></a> </li>
                                        <li><a href="#" title="白色"><img src="${goodsDetail.goodsDetailImgHttpURL2}" width="35" height="35"></a> </li>
                                        <li><a href="#" title="金色"><img src="${goodsDetail.goodsDetailImgHttpURL3}" width="35" height="35"></a> </li>
                            ...
                            <div class="pc-telling clearfix">
                                ...
                                <div class="pc-adults clearfix">
                                    ...
                                    <div class="fl pc-stock ">库存<em>${goodsCount}</em>件</div>
                                </div>
                            </div>
                            <div class="pc-number clearfix"><span class="fl">商品编号:${goods.goodsNum}</span> <span class="fr">分享 收藏</span></div>
                        </div>
                        <div class="pc-emption">
                            <a href="#">立即购买</a>
                            <a href="/addGoodsToShoppingCart" class="join">加入购物车</a>
                        </div>
                    </div>
                    <div class="pc-product-s">
                        <div class="pc-shoplo"><a href="#"><img src="theme/icon/shop-logo.png"></a> </div>
                        <div class="pc-shopti">
                            <h2>${goods.goodsSupplier}</h2>
                            <p>公司名称：${goods.goodsSupplier}</p>
                            <p>所在地:${goodsSupplier.goodsSupplierCompanyAddress}</p>
                        </div>
