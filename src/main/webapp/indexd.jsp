...
<header id="pc-header">
    <div class="BHeader">
        <div class="yNavIndex">
            <ul class="BHeaderl">
                ...
                <li class="headerul">|</li>
                <li><a href="/Administrator/right.jsp">后台管理</a> </li>
                <li class="headerul">|</li>
    ...
    <div class="container clearfix">
        ...
        <div class="header-cart fr"><a href="#"><img src="theme/icon/car.png"></a> <i class="head-amount"></i></div>
            ...
            <div class="pullDown">
                ...
                <ul class="pullDownList">
                    <c:forEach items="${goodsTypeList}" var="goodsType">
                        <li>
                            <i class="listi2"></i>
                            <a href="/selectGoodsByGoodsType?goodsTypeName=${goodsType.goodsTypeName}" target="_blank">${goodsType.goodsTypeName}</a>
                            <span></span>
                        </li>
                    </c:forEach>
...
<section id="pc-advert">
    <div class="container-c clearfix">
        <a href="page.html" target="_blank"><img src="theme/img/pd/pd1.png"></a>
