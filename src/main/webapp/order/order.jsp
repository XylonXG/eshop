...
<header id="pc-header">
    <div class="BHeader">
        <div class="yNavIndex">
            <ul class="BHeaderl">
                <li><a href="#">会员:${user.username}</a> </li>
    ...
    <div class="containers">
                ...
                <div class="pc-order-text clearfix">
                    <ul class=" clearfix">
                        <li class="clearfix fl">
                            ...
                            <div class="fl pc-address"><span>订单编号:${order.orderNum}</span> <span>手机号:${user.userPhone} </span> <span>${order.userDetailAddress}</span></div>
                        </li>
                        <li class="fr">
                    ...
                    <div class="pc-order-text clearfix">
                        ...
                        <c:forEach items="${shoppingCartList}" var="shoppingCart">
                            <div class="clearfix pc-wares-p">
                                <div class="fl pc-wares"><a href="#"><img src="${shoppingCart.goodsDetailImgHttpURL1}"></a></div>
                                <div class="fl pc-wares-w"> <a href="#">${shoppingCart.goodsDesc}</a> <p class="clearfix"><span class="fl">颜色：白色</span><span class="fr">版本：联通高</span></p></div>
                                <div class="fl pc-wares-s"><span class="reds">￥${shoppingCart.salePrice}</span><span>x${shoppingCart.buyCount}</span><span>有货</span></div>
                            </div>
        ...
        <div class="clearfix">
            <div class="fr pc-list-t">
                <ul>
                    <li><span><b>2</b> 件商品，总商品金额：</span> <em>￥${order.orderTotalMoney}</em></li>
                    <li><span>减额：</span> <em>￥0.00</em></li>
                    <li><span>运费：</span> <em>￥8.00</em></li>
                    <li><span>应付总额：</span> <em>￥${order.orderTotalMoney-8}</em></li>
                    <li><span>减额：</span> <em>￥0.00</em></li>
                </ul>
            </div>
        </div>
        ...
        <div class="clearfix">
            <div class="fr pc-space-j">
                <spna>应付总额：<strong>￥${order.orderTotalMoney-8}</strong></spna>
                <button class="pc-submit" type="submit"><a href="/userApply">支付</a></button>
            </div>
        </div>
    </div>
</section>
