    ...
    <div class="containers">
        ...
        <div class="pc-border">
            <div class="pc-order-text">
                <p>订单提交成功，请您尽快付款！   订单号 ：<em>${order.orderNum}</em></p>
                <p class="reds">请您在提交订单后24小时内完成付款，否则订单自动取消。</p>
            </div>
            <div class="pc-line"></div>
            <div class="pc-order-text">
                <c:forEach items="${shoppingCartList}" var="shoppingCart">
                    <p>商品名称：${shoppingCart.goodsDesc} </p>
                </c:forEach>

                <p>收货地址：${order.userDetailAddress}</p>
                 <p>   收货人：${user.userTrueName} ${user.userPhone}</p>
            </div>
        </div>
    </div>
</section>
...
<div class="pc-buying clearfix" style="margin-top:30px">
    <div class="time-list time-list-w fl">
        <div class="time-title">
            ...
            <span class="pc-order-price">总价：￥${order.orderTotalMoney-8}</span>
        </div>
        <div class="time-border time-border-h clearfix">
            <div class="time-border-list pc-shop-clear pc-order-clear H-over clearfix">
                <ul class="pc-order-list clearfix">
                    <li><a href="#"><img src="/theme/bank/1514886255318.png"></a> </li>
                </ul>
            </div>
            ...
            <div class="pc-order-go"><a href="#">支付宝扫码</a></div>
        </div>
    </div>
</div>
